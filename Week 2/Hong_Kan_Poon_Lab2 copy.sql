...
SELECT *, SUBSTR(lastName, 3,1) from Customer
    WHERE firstName LIKE '%t%' OR lastName LIKE '%t%'
    OR firstName LIKE '%T%' OR lastName LIKE '%T%'
...
SELECT LOWER(SUBSTR(Title, 1, 20)) FROM album
